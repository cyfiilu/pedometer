...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.lib.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.lib.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.lib.swipeback.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.lib.swipeback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system

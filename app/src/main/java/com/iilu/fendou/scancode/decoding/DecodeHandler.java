...
package com.iilu.fendou.scancode.decoding;
...
import com.iilu.fendou.scancode.camera.PlanarYUVLuminanceSource;
...
final class DecodeHandler extends Handler {
  ...
  private void decode(byte[] data, int width, int height) {
	if ((data == null)||(data.length<=0)) { return;}// liu 判断以防null指针异常

...
package com.iilu.fendou.scancode.camera;
...
public final class CameraManager {
    ...
    private static final int MIN_FRAME_WIDTH = SystemUtil.dip2px(MainApplication.getAppContext(), 240);
    private static final int MIN_FRAME_HEIGHT = SystemUtil.dip2px(MainApplication.getAppContext(), 240);
    private static final int MAX_FRAME_WIDTH = SystemUtil.dip2px(MainApplication.getAppContext(), 600);
    private static final int MAX_FRAME_HEIGHT = SystemUtil.dip2px(MainApplication.getAppContext(), 400);

package com.iilu.fendou.views.wheel;
/**
...
import com.iilu.fendou.adapters.wheel.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     */
    private int[] SHADOWS_COLORS = new int[]{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF};
    ...
    private void initResourcesIfNecessary() {
        if (centerDrawable == null) {//此处是滚动区的形状
            centerDrawable = getContext().getResources().getDrawable(wheelForeground);
        }

        if (topShadow == null) {//view最上边上的颜色遮盖去的设置
            topShadow = new GradientDrawable(Orientation.TOP_BOTTOM, SHADOWS_COLORS);
        }

        if (bottomShadow == null) {//view最下边上的颜色遮盖去的设置
    ...
    private void drawShadows(Canvas canvas) {
        int height = (int) (/*1.5*/2.5 * getItemHeight());

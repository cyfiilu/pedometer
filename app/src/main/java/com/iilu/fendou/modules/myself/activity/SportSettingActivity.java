...
public class SportSettingActivity extends MainPreferenceActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) titleLayout.findViewById(R.id.tv_title)).setText("计步器设置");
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (mDayGoalStepNum == preference) {
            ...
            motifyParameter(R.array.zhaozhao_time_range, R.array.zhaozhao_time_range, -1, "\"朝朝\"时间", 4);
            ...
            motifyParameter(R.array.mumu_time_range, R.array.mumu_time_range, -1, "\"暮暮\"时间", 6);
    ...
    private void motifyParameter(int parentResId, int childResId, int subChildResId, String dialogText, int type) {
        mSportSettingDialog = new SportSettingDialog(this, this, parentResId, childResId, subChildResId);
        ...
        switch (mType) {
            case 1:// 每日目标步数
                ...
                if (stepAimDay < 3000 || stepAimDay > 30000) {
                    SimpleHUD.showInfoMessage(this, "设置范围3000~30000", 1000);
                    return;
                }
            ...
            case 3:// 步幅
                ...
                if (stepWidth < 20 || stepWidth > 120) {
                    SimpleHUD.showInfoMessage(this, "设置范围20~120cm", 1000);
                    return;
                }
            ...
            case 4:// 朝三时间
                ...
                if (morningTime[0] >= morningTime[1]) {
                    SimpleHUD.showInfoMessage(this, "开始时间需早于结束时间~", 1000);
                    return;
                }
            ...
            case 5:// 朝三目标
                ...
                if (morningAim < 3000 || morningAim > 8000) {
                    SimpleHUD.showInfoMessage(this, "设置范围3000~8000", 1000);
                    return;
                }

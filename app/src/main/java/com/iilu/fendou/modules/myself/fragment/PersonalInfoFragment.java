...
public class PersonalInfoFragment extends MainPreferenceFragment implements View.OnClickListener {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (mUserSex == preference) {
            ...
            mCityDialog = new CityDialog(mActivity, this, mMapDatas, null, mProvince, mMapDatas.get(mProvince[mProvinceIndex]));
            mCityDialog.setDialogText("城市");
            setUnitAccordType(4);
            this.mType = 4;
        } else if (mUserCodeCard == preference) {
            CodeCardDialog codeCardDialog = new CodeCardDialog(mActivity, R.style.NewDialogSytle);
            codeCardDialog.show();
    ...
    private void motifyParameter(int parentResId, int childResId, int subChildResId, String dialogText, int type) {
        mSettingDialog = new PersonalInfoSettingDialog(mActivity, this, parentResId, childResId, subChildResId);
        ...
        switch (mType) {
            ...
            case 2:
                ...
                if (height < 80 || height > 260) {
                    SimpleHUD.showInfoMessage(mActivity, "设置范围100~260cm", 1000);
                    return;
                }

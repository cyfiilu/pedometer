...
public class SlidingDirectionDialog extends Dialog implements CompoundButton.OnCheckedChangeListener {

    private final Logger mlog = Logger.getLogger(SlidingDirectionDialog.class.getSimpleName());
    ...
    public SlidingDirectionDialog(Context context) {
        this(context, 0);
    }

    public SlidingDirectionDialog(Context context, int theme) {
        super(context, theme);
        ...
        mRadioButton_1.setText("左侧");
        mRadioButton_2.setText("右侧");
        ...
        if (isChecked) {
            switch (buttonView.getId()) {
                case R.id.radio_button_1:
                    ...
                    SPrefUtil_2.put(mContext, PrefsConfig.APP_CONST, "isLeftSliding", true);
                    break;
                case R.id.radio_button_2:
                    mValue = buttonView.getText().toString();
                    SPrefUtil_2.put(mContext, PrefsConfig.APP_CONST, "isLeftSliding", false);
                    break;
            }
        }
        dismiss();
